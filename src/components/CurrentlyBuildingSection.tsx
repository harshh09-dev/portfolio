      ...
      <div className="mx-auto max-w-6xl">
        <ScrollReveal scale>
          <motion.div
            ...
            className="overflow-hidden rounded-2xl border border-primary/30 bg-gradient-to-br from-card to-primary/5 p-8 transition-all duration-500 hover:shadow-[0_0_80px_-20px_hsl(330,80%,60%,0.12)] md:p-12"
          >
              ...
              <div>
                ...
                <div className="mt-6 flex flex-wrap gap-3">
                  {["Raspberry Pi", "Python", "Android", "Edge Computing", "Privacy-First"].map((tag) => (
                    <span key={tag} className="rounded-full border border-primary/30 bg-primary/10 px-3 py-1 text-xs font-medium text-primary transition-all duration-300 hover:bg-primary hover:text-primary-foreground">
                      {tag}
                    </span>
                  ))}
                </div>
